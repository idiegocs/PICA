...
namespace KallSonysB2C
{
    public partial class ProductList : System.Web.UI.Page
    {
                            ...
                            [RouteData] string categoryName)
        {
            ...
            try
            {
                if (categoryName == null)
                {
                    ...
                    listaProductos = obj.listaProductos(x, y, 1);
                }
                else
                {
                    // si se filtro por categoria
                    listaProductos = obj.listaProductos("S", categoryName, 1);
                }
            }
            catch (Exception e)
            {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            //if (DataPagerProducts.StartRowIndex > DataPagerProducts.TotalRowCount)
