<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="KallSonysB2C.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    SelectMethod="GetCategories" DataTextField="NombreSubcategoria" 
                    DataValueField="IdSubcategoria" >
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="KallSonysB2C.Models.Product" 
