...
[assembly: WebActivator.PostApplicationStartMethod( typeof(KallSonysB2C.App_Start.UnityWebFormsStart), "PostStart" )]
namespace KallSonysB2C.App_Start
{
	/// <summary>
	...
	internal static class UnityWebFormsStart
	{
		...
		private static void RegisterDependencies( IUnityContainer container )
		{
            ...
            UnityInjector.DependencyLoader(container);
		}
	}
}