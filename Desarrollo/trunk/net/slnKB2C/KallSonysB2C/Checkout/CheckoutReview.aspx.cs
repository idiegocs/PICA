...
namespace KallSonysB2C.Checkout
{
    ...
    {
        [Dependency]
        public IBusiness.ICompraBL objCompra { get; set; }
        ...
        {
            //UbicacionBL pais = new UbicacionBL();
            //ddlPais.DataSource = pais.getPais();

            ddlPais.DataSource = Application["Pais"];
            ...
            ddlDepartamento.AutoPostBack = true;

        }

        //[WebMethod]
        //public static List<DepartamentoDTO> GetDepartamentoByPais(int IdPais)
        //{
        //    List<DepartamentoDTO> lstDepartamento = new List<DepartamentoDTO>();
        //    lstDepartamento = (List<DepartamentoDTO>)HttpContext.Current.Session["Departamento"];

        //    var query = from item in lstDepartamento
        //                where item.idPais == IdPais
        //                select item;

        //    return query.ToList<DepartamentoDTO>();
        //}

        private void cargaDepartamento(int idPais)
        {
            ddlDepartamento.Items.Clear();
            //UbicacionBL dep = new UbicacionBL();
            //ddlDepartamento.DataSource = dep.getDepartamento(idPais);

            List<DepartamentoDTO> lstDepartamento = new List<DepartamentoDTO>();
            lstDepartamento = (List<DepartamentoDTO>)Application["Departamento"];

            var query = from item in lstDepartamento
                        where item.idPais == idPais
                        select item;

            ddlDepartamento.DataSource = query.ToList<DepartamentoDTO>();
        ...
        //[WebMethod]
        //public static List<CiudadDTO> GetCiudadByDepar(int IdDepartamento)
        //{
        //    List<CiudadDTO> lstCiudad = new List<CiudadDTO>();
        //    lstCiudad = (List<CiudadDTO>)HttpContext.Current.Session["Ciudad"];

        //    var query = from item in lstCiudad
        //                where item.idDepartamento == IdDepartamento
        //                select item;

        //    return query.ToList<CiudadDTO>();
        //}

        private void cargaCiudad(int idDepartamento)
        {
            ddlCiudad.Items.Clear();
            //UbicacionBL mun = new UbicacionBL();
            //ddlCiudad.DataSource = mun.getCiudad(idDepartamento);

            List<CiudadDTO> lstCiudad = new List<CiudadDTO>();
            lstCiudad = (List<CiudadDTO>)Application["Ciudad"];

            var query = from item in lstCiudad
                        where item.idDepartamento == idDepartamento
                        select item;

            ddlCiudad.DataSource = query.ToList<CiudadDTO>();
