    ...
    public partial class DealsDetails : System.Web.UI.Page
    {
                        ...
                        [RouteData] string dealName)
        {
            ...
            if (listaCampanias != null)
            {
                ...
                //    }
                //}
                listaCamp = (from item in listaCampanias
                             where item.IdCampania == int.Parse(dealName)
                             select item).ToList();
            }
            cargarProductosxCampania(listaCamp[0]);
            return listaCamp;
        }
        ...
        //protected void lnkAddToCartPxC_Click(object sender, EventArgs e)
        //{
        //    LinkButton link = sender as LinkButton;
