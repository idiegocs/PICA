...
namespace KB2C.Data
{
    public class OrdenDAL : IData.IOrdenDAL
    {
        //
        public List<OrdenDTO> ConsultarOrdenesUsuario(int idOrden, ClienteDTO cliente, string estadoOrden)
        {
            ...
            try
            {
                ...
                ServiceOrdenes.ConsultaOrdenSalida salida = new ServiceOrdenes.ConsultaOrdenSalida();
                ...
                foreach (var item in salida.listaOrdenes)
                {
                    ...
                    ord.fechaOrden = (item.fechaOrden == null ? Convert.ToDateTime("2015-02-03") : item.fechaOrden);
