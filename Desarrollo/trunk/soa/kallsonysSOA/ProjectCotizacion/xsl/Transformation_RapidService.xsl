...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [TUE JUN 02 13:37:43 COT 2015]. -->
?>
  ...
  <xsl:template match="/">
    <tns:fullfillOrder>
      <tns:envio>
        ...
        <ns6:country>
          <xsl:value-of select="/ns1:cotizacionEntrada/ns1:usuarioEnvio/direccion/idPais"/>
        </ns6:country>
        <ns6:items>
        ...
        <ns6:supplier>
          <xsl:value-of select="string('RAPIDSERVICE')"/>
        </ns6:supplier>
        <ns6:zipcode>
