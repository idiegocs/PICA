<%@ Page Title="Confirmar Orden" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" EnableEventValidation="False"
            ...
            <table style="width:100%">
                <tr>
                    <td style="align-content:center">
                        ...
                        <asp:DropDownList ID="ddlPais" Width="150px" runat="server" DataTextField="nombrePais" DataValueField="idPais" AutoPostBack="true" OnSelectedIndexChanged="ddlPais_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                    <td>
                        <asp:Label ID="lblDepar" runat="server" Font-Bold="true">Departamento</asp:Label>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlDepartamento" Width="150px" runat="server" DataTextField="nombreDepartamento" DataValueField="idDepartamento" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartamento_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                    <td>
                        <asp:Label ID="lblCiudad" runat="server" Font-Bold="true">Ciudad</asp:Label>&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlCiudad" Width="150px" runat="server" AutoPostBack="false" DataTextField="nombreCiudad" DataValueField="idCiudad"></asp:DropDownList>
                    </td>
                </tr>
            </table>
        </div>
